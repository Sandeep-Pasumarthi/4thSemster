...
QueueNode *newNode(char, unsigned);
...
QueueNode *getFront(Queue *);
QueueNode *findMin(Queue *, Queue *);
int isLeaf(QueueNode *);
void printArr(int[], int);
QueueNode *buildHuffmanTree(char[], int[], int);
void printCodes(QueueNode *, int[], int);
void HuffmanCodes(char[], int[], int);

int main()
{
    char arr[] = {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l'};
    int freq[] = {5, 9, 12, 13, 16, 45, 60, 73, 89, 101, 110, 111};
